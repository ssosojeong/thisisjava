...
public class DateTimeInfoExample {
	...
	public static void main(String[] args) {
		...
		if(dow == DayOfWeek.MONDAY ) {strDateTime += "월요일 ";}
		else if(dow == DayOfWeek.TUESDAY ) {strDateTime += "화요일 ";}
		else if(dow == DayOfWeek.WEDNESDAY ) {strDateTime += "수요일 ";}
		else if(dow == DayOfWeek.THURSDAY ) {strDateTime += "목요일 ";}
		else if(dow == DayOfWeek.FRIDAY ) {strDateTime += "금요일 ";}
		else if(dow == DayOfWeek.SATURDAY ) {strDateTime += "토요일 ";}
		else {strDateTime += "일요일";}
		...
		if(nowDate.isLeapYear()) {System.out.println("올해는 윤년: 2월은 29일까지 있습니다. \n");}
		else {System.out.println("올해는 평년: 2월은 28일까지 있습니다. \n");}

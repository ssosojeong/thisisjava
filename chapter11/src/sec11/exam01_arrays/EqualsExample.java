...
public class EqualsExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("1차 배열 항목 값을 비교: " + Arrays.equals(original, clone1));
		System.out.println("중첩 배열 항목 값을 비교: " + Arrays.deepEquals(original, clone1));
		...
		System.out.println("1차 배열 항목 값을 비교: " + Arrays.equals(original, clone2));
		System.out.println("중첩 배열 항목 값을 비교: " + Arrays.deepEquals(original, clone2));
